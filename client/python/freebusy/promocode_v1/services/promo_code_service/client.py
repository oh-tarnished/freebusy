...
from .transports.grpc import PromoCodeServiceGrpcTransport
from .transports.grpc_asyncio import PromoCodeServiceGrpcAsyncIOTransport


class PromoCodeServiceClientMeta(type):
    """Metaclass for the PromoCodeService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[PromoCodeServiceTransport]]
    _transport_registry["grpc"] = PromoCodeServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = PromoCodeServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[PromoCodeServiceTransport]:
...
class PromoCodeServiceClient(metaclass=PromoCodeServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PromoCodeServiceClient: The constructed client.
        """
    ...
    def transport(self) -> PromoCodeServiceTransport:
        ...
        Returns:
            PromoCodeServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def promo_code_path(promo_code: str,) -> str:
        """Returns a fully-qualified promo_code string."""
        return "promoCodes/{promo_code}".format(promo_code=promo_code, )

    @staticmethod
    def parse_promo_code_path(path: str) -> Dict[str,str]:
        """Parses a promo_code path into its component segments."""
        m = re.match(r"^promoCodes/(?P<promo_code>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def redemption_path(promo_code: str,redemption: str,) -> str:
        """Returns a fully-qualified redemption string."""
        return "promoCodes/{promo_code}/redemptions/{redemption}".format(promo_code=promo_code, redemption=redemption, )

    @staticmethod
    def parse_redemption_path(path: str) -> Dict[str,str]:
        """Parses a redemption path into its component segments."""
        m = re.match(r"^promoCodes/(?P<promo_code>.+?)/redemptions/(?P<redemption>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = PromoCodeServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint) -> str:
        ...
        if api_override is not None:
            ...
            api_endpoint = PromoCodeServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = PromoCodeServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PromoCodeServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PromoCodeServiceTransport, Callable[..., PromoCodeServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the promo code service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PromoCodeServiceClient._read_environment_variables()
        self._client_cert_source = PromoCodeServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = PromoCodeServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, PromoCodeServiceTransport)
        if transport_provided:
            # transport is a PromoCodeServiceTransport instance.
            ...
            self._transport = cast(PromoCodeServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            PromoCodeServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PromoCodeServiceTransport], Callable[..., PromoCodeServiceTransport]] = (
                PromoCodeServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., PromoCodeServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `freebusy.promocode_v1.PromoCodeServiceClient`.",
                    extra = {
    ...
    def list_promo_codes(self,
        ...
        .. code-block:: python
            ...
            def sample_list_promo_codes():
                # Create a client
                client = promocode_v1.PromoCodeServiceClient()
        ...
        Args:
            request (Union[freebusy.promocode_v1.types.ListPromoCodesRequest, dict]):
        ...
        Returns:
            freebusy.promocode_v1.services.promo_code_service.pagers.ListPromoCodesPager:
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_promo_codes]
        ...
        response = pagers.ListPromoCodesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_promo_code(self,
        ...
        .. code-block:: python
            ...
            def sample_get_promo_code():
                ...
                # Make the request
                response = client.get_promo_code(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.promocode_v1.types.GetPromoCodeRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_promo_code]
    ...
    def create_promo_code(self,
        ...
        .. code-block:: python
            ...
            def sample_create_promo_code():
                ...
                # Make the request
                response = client.create_promo_code(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.promocode_v1.types.CreatePromoCodeRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_promo_code]
    ...
    def update_promo_code(self,
        ...
        .. code-block:: python
            ...
            def sample_update_promo_code():
                ...
                # Make the request
                response = client.update_promo_code(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.promocode_v1.types.UpdatePromoCodeRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_promo_code]
    ...
    def delete_promo_code(self,
        ...
        Args:
            request (Union[freebusy.promocode_v1.types.DeletePromoCodeRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_promo_code]
    ...
    def validate_promo_code(self,
        ...
        .. code-block:: python
            ...
            def sample_validate_promo_code():
                # Create a client
                client = promocode_v1.PromoCodeServiceClient()
                ...
                # Make the request
                response = client.validate_promo_code(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.promocode_v1.types.ValidatePromoCodeRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.validate_promo_code]
    ...
    def list_redemptions(self,
        ...
        Args:
            request (Union[freebusy.promocode_v1.types.ListRedemptionsRequest, dict]):
        ...
        Returns:
            freebusy.promocode_v1.services.promo_code_service.pagers.ListRedemptionsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_redemptions]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListRedemptionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_redemption(self,
        ...
        .. code-block:: python
            ...
            def sample_get_redemption():
                ...
                # Make the request
                response = client.get_redemption(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.promocode_v1.types.GetRedemptionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_redemption]
    ...
    def __enter__(self) -> "PromoCodeServiceClient":
        return self
