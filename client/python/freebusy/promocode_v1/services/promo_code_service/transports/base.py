...
class PromoCodeServiceTransport(abc.ABC):
    """Abstract transport class for PromoCodeService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_promo_codes: gapic_v1.method.wrap_method(
                self.list_promo_codes,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_promo_code: gapic_v1.method.wrap_method(
                self.get_promo_code,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_promo_code: gapic_v1.method.wrap_method(
                self.create_promo_code,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_promo_code: gapic_v1.method.wrap_method(
                self.update_promo_code,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_promo_code: gapic_v1.method.wrap_method(
                self.delete_promo_code,
                default_timeout=None,
                client_info=client_info,
            ),
            self.validate_promo_code: gapic_v1.method.wrap_method(
                self.validate_promo_code,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_redemptions: gapic_v1.method.wrap_method(
                self.list_redemptions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_redemption: gapic_v1.method.wrap_method(
                self.get_redemption,
                default_timeout=None,
                client_info=client_info,
            ),
