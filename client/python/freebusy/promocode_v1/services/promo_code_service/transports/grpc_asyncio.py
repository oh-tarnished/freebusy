...
from .grpc import PromoCodeServiceGrpcTransport
...
class PromoCodeServiceGrpcAsyncIOTransport(PromoCodeServiceTransport):
    """gRPC AsyncIO backend transport for PromoCodeService.
    ...
    def list_promo_codes(self) -> Callable[
            ...
            Awaitable[promocode_messages.ListPromoCodesResponse]]:
        ...
        Returns:
            Callable[[~.ListPromoCodesRequest],
                    Awaitable[~.ListPromoCodesResponse]]:
    ...
    def validate_promo_code(self) -> Callable[
            ...
            Awaitable[promocode_messages.ValidatePromoCodeResponse]]:
        ...
        Returns:
            Callable[[~.ValidatePromoCodeRequest],
                    Awaitable[~.ValidatePromoCodeResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_redemptions(self) -> Callable[
            ...
            Awaitable[promocode_messages.ListRedemptionsResponse]]:
        ...
        Returns:
            Callable[[~.ListRedemptionsRequest],
                    Awaitable[~.ListRedemptionsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_redemption(self) -> Callable[
            ...
            Awaitable[promocode.Redemption]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_promo_codes: self._wrap_method(
                self.list_promo_codes,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_promo_code: self._wrap_method(
                self.get_promo_code,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_promo_code: self._wrap_method(
                self.create_promo_code,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_promo_code: self._wrap_method(
                self.update_promo_code,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_promo_code: self._wrap_method(
                self.delete_promo_code,
                default_timeout=None,
                client_info=client_info,
            ),
            self.validate_promo_code: self._wrap_method(
                self.validate_promo_code,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_redemptions: self._wrap_method(
                self.list_redemptions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_redemption: self._wrap_method(
                self.get_redemption,
                default_timeout=None,
                client_info=client_info,
            ),
...
__all__ = (
    'PromoCodeServiceGrpcAsyncIOTransport',
)
