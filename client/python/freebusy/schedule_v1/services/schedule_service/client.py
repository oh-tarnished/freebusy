...
class ScheduleServiceClient(metaclass=ScheduleServiceClientMeta):
    ...
    @staticmethod
    def availability_exception_path(resource: str,availability_exception: str,) -> str:
        """Returns a fully-qualified availability_exception string."""
        return "resources/{resource}/availabilityExceptions/{availability_exception}".format(resource=resource, availability_exception=availability_exception, )

    @staticmethod
    def parse_availability_exception_path(path: str) -> Dict[str,str]:
        """Parses a availability_exception path into its component segments."""
        m = re.match(r"^resources/(?P<resource>.+?)/availabilityExceptions/(?P<availability_exception>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def schedule_path(resource: str,) -> str:
        """Returns a fully-qualified schedule string."""
        return "resources/{resource}/schedule".format(resource=resource, )

    @staticmethod
    def parse_schedule_path(path: str) -> Dict[str,str]:
        """Parses a schedule path into its component segments."""
        m = re.match(r"^resources/(?P<resource>.+?)/schedule$", path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `freebusy.schedule_v1.ScheduleServiceClient`.",
                    extra = {
    ...
    def get_schedule(self,
        ...
        .. code-block:: python
            ...
            def sample_get_schedule():
                # Create a client
                client = schedule_v1.ScheduleServiceClient()
        ...
        Args:
            request (Union[freebusy.schedule_v1.types.GetScheduleRequest, dict]):
    ...
    def update_schedule(self,
        ...
        Args:
            request (Union[freebusy.schedule_v1.types.UpdateScheduleRequest, dict]):
    ...
    def list_availability_exceptions(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.ListAvailabilityExceptionsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_availability_exceptions():
                # Create a client
                client = schedule_v1.ScheduleServiceClient()
        ...
        Args:
            request (Union[freebusy.schedule_v1.types.ListAvailabilityExceptionsRequest, dict]):
        ...
        Returns:
            freebusy.schedule_v1.services.schedule_service.pagers.ListAvailabilityExceptionsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_availability_exceptions]
        ...
        response = pagers.ListAvailabilityExceptionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_availability_exception(self,
        ...
        .. code-block:: python
            ...
            def sample_get_availability_exception():
                # Create a client
                client = schedule_v1.ScheduleServiceClient()
                ...
                # Make the request
                response = client.get_availability_exception(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.schedule_v1.types.GetAvailabilityExceptionRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_availability_exception]
    ...
    def create_availability_exception(self,
        ...
        .. code-block:: python
            ...
            def sample_create_availability_exception():
                # Create a client
                client = schedule_v1.ScheduleServiceClient()
                ...
                # Make the request
                response = client.create_availability_exception(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.schedule_v1.types.CreateAvailabilityExceptionRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_availability_exception]
    ...
    def delete_availability_exception(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_availability_exception():
                # Create a client
                client = schedule_v1.ScheduleServiceClient()
        ...
        Args:
            request (Union[freebusy.schedule_v1.types.DeleteAvailabilityExceptionRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_availability_exception]
