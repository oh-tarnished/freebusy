...
from .services.identity_service import IdentityServiceClient
from .services.identity_service import IdentityServiceAsyncClient
...
from .types.identity import MembershipSummary
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):   # pragma: NO COVER
    api_core.check_python_version("freebusy.identity_v1") # type: ignore
    api_core.check_dependency_versions("freebusy.identity_v1") # type: ignore
    ...
    try:
        ...
        _package_label = "freebusy.identity_v1"
