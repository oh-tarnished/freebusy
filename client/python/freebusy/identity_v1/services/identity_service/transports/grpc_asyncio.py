...
from .base import IdentityServiceTransport, DEFAULT_CLIENT_INFO
from .grpc import IdentityServiceGrpcTransport
...
class IdentityServiceGrpcAsyncIOTransport(IdentityServiceTransport):
    """gRPC AsyncIO backend transport for IdentityService.
    ...
    def get_user(self) -> Callable[
            ...
            Awaitable[identity.User]]:
        r"""Return a callable for the get user method over gRPC.

        Returns a user. Use "users/me" for the signed-in
        caller.
        ...
        if 'get_user' not in self._stubs:
            self._stubs['get_user'] = self._logged_channel.unary_unary(
                '/freebusy.identity.v1.IdentityService/GetUser',
    ...
    def list_users(self) -> Callable[
            ...
            Awaitable[identity.ListUsersResponse]]:
        ...
        if 'list_users' not in self._stubs:
            self._stubs['list_users'] = self._logged_channel.unary_unary(
                '/freebusy.identity.v1.IdentityService/ListUsers',
    ...
    def update_user(self) -> Callable[
        ...
        if 'update_user' not in self._stubs:
            self._stubs['update_user'] = self._logged_channel.unary_unary(
                '/freebusy.identity.v1.IdentityService/UpdateUser',
...
__all__ = (
    'IdentityServiceGrpcAsyncIOTransport',
)
