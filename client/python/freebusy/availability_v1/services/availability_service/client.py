...
from .transports.grpc import AvailabilityServiceGrpcTransport
from .transports.grpc_asyncio import AvailabilityServiceGrpcAsyncIOTransport


class AvailabilityServiceClientMeta(type):
    """Metaclass for the AvailabilityService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AvailabilityServiceTransport]]
    _transport_registry["grpc"] = AvailabilityServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = AvailabilityServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[AvailabilityServiceTransport]:
...
class AvailabilityServiceClient(metaclass=AvailabilityServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AvailabilityServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AvailabilityServiceTransport:
        ...
        Returns:
            AvailabilityServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = AvailabilityServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint) -> str:
        ...
        if api_override is not None:
            ...
            api_endpoint = AvailabilityServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AvailabilityServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AvailabilityServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AvailabilityServiceTransport, Callable[..., AvailabilityServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the availability service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AvailabilityServiceClient._read_environment_variables()
        self._client_cert_source = AvailabilityServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AvailabilityServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AvailabilityServiceTransport)
        if transport_provided:
            # transport is a AvailabilityServiceTransport instance.
            ...
            self._transport = cast(AvailabilityServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            AvailabilityServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AvailabilityServiceTransport], Callable[..., AvailabilityServiceTransport]] = (
                AvailabilityServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AvailabilityServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `freebusy.availability_v1.AvailabilityServiceClient`.",
                    extra = {
    ...
    def compute_availability(self,
        ...
        .. code-block:: python
            ...
            def sample_compute_availability():
                # Create a client
                client = availability_v1.AvailabilityServiceClient()
                ...
                # Make the request
                response = client.compute_availability(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.availability_v1.types.ComputeAvailabilityRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.compute_availability]
    ...
    def check_availability(self,
        ...
        .. code-block:: python
            ...
            def sample_check_availability():
                ...
                # Make the request
                response = client.check_availability(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.availability_v1.types.CheckAvailabilityRequest, dict]):
                The request object. Request message for
                CheckAvailability.
            resource (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.check_availability]
    ...
    def compute_bookable_ranges(self,
        ...
        .. code-block:: python
            ...
            def sample_compute_bookable_ranges():
                # Create a client
                client = availability_v1.AvailabilityServiceClient()
                ...
                # Make the request
                response = client.compute_bookable_ranges(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.availability_v1.types.ComputeBookableRangesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.compute_bookable_ranges]
    ...
    def batch_compute_availability(self,
        ...
        .. code-block:: python
            ...
            def sample_batch_compute_availability():
                # Create a client
                client = availability_v1.AvailabilityServiceClient()
                ...
                # Make the request
                response = client.batch_compute_availability(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.availability_v1.types.BatchComputeAvailabilityRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_compute_availability]
    ...
    def search_availability(self,
            ...
            *,
            ...
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> pagers.SearchAvailabilityPager:
        ...
        .. code-block:: python
            ...
            def sample_search_availability():
                # Create a client
                client = availability_v1.AvailabilityServiceClient()
        ...
        Args:
            request (Union[freebusy.availability_v1.types.SearchAvailabilityRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            freebusy.availability_v1.services.availability_service.pagers.SearchAvailabilityPager:
                Response message for
                SearchAvailability.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_availability]
        ...
        response = pagers.SearchAvailabilityPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "AvailabilityServiceClient":
        return self
