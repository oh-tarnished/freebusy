...
from .transports.grpc import BookingServiceGrpcTransport
from .transports.grpc_asyncio import BookingServiceGrpcAsyncIOTransport


class BookingServiceClientMeta(type):
    """Metaclass for the BookingService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[BookingServiceTransport]]
    _transport_registry["grpc"] = BookingServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = BookingServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[BookingServiceTransport]:
...
class BookingServiceClient(metaclass=BookingServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            BookingServiceClient: The constructed client.
        """
    ...
    def transport(self) -> BookingServiceTransport:
        ...
        Returns:
            BookingServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def booking_path(booking: str,) -> str:
        """Returns a fully-qualified booking string."""
        return "bookings/{booking}".format(booking=booking, )

    @staticmethod
    def parse_booking_path(path: str) -> Dict[str,str]:
        """Parses a booking path into its component segments."""
        m = re.match(r"^bookings/(?P<booking>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = BookingServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint) -> str:
        ...
        if api_override is not None:
            ...
            api_endpoint = BookingServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = BookingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = BookingServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BookingServiceTransport, Callable[..., BookingServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the booking service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BookingServiceClient._read_environment_variables()
        self._client_cert_source = BookingServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BookingServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, BookingServiceTransport)
        if transport_provided:
            # transport is a BookingServiceTransport instance.
            ...
            self._transport = cast(BookingServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            BookingServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BookingServiceTransport], Callable[..., BookingServiceTransport]] = (
                BookingServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., BookingServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `freebusy.booking_v1.BookingServiceClient`.",
                    extra = {
    ...
    def create_booking(self,
        ...
        .. code-block:: python
            ...
            def sample_create_booking():
                # Create a client
                client = booking_v1.BookingServiceClient()
                ...
                # Make the request
                response = client.create_booking(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.booking_v1.types.CreateBookingRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_booking]
    ...
    def get_booking(self,
        ...
        .. code-block:: python
            ...
            def sample_get_booking():
                ...
                # Make the request
                response = client.get_booking(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.booking_v1.types.GetBookingRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_booking]
    ...
    def list_bookings(self,
        ...
        Args:
            request (Union[freebusy.booking_v1.types.ListBookingsRequest, dict]):
        ...
        Returns:
            freebusy.booking_v1.services.booking_service.pagers.ListBookingsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_bookings]
        ...
        response = pagers.ListBookingsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def confirm_booking(self,
        ...
        .. code-block:: python
            ...
            def sample_confirm_booking():
                ...
                # Make the request
                response = client.confirm_booking(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.booking_v1.types.ConfirmBookingRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.confirm_booking]
    ...
    def cancel_booking(self,
        ...
        .. code-block:: python
            ...
            def sample_cancel_booking():
                ...
                # Make the request
                response = client.cancel_booking(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.booking_v1.types.CancelBookingRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.cancel_booking]
    ...
    def preview_cancellation(self,
        ...
        .. code-block:: python
            ...
            def sample_preview_cancellation():
                # Create a client
                client = booking_v1.BookingServiceClient()
                ...
                # Make the request
                response = client.preview_cancellation(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.booking_v1.types.PreviewCancellationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.preview_cancellation]
    ...
    def reschedule_booking(self,
        ...
        .. code-block:: python
            ...
            def sample_reschedule_booking():
                ...
                # Make the request
                response = client.reschedule_booking(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.booking_v1.types.RescheduleBookingRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reschedule_booking]
    ...
    def __enter__(self) -> "BookingServiceClient":
        return self
