...
class BookingServiceTransport(abc.ABC):
    """Abstract transport class for BookingService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_booking: gapic_v1.method.wrap_method(
                self.create_booking,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_booking: gapic_v1.method.wrap_method(
                self.get_booking,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_bookings: gapic_v1.method.wrap_method(
                self.list_bookings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.confirm_booking: gapic_v1.method.wrap_method(
                self.confirm_booking,
                default_timeout=None,
                client_info=client_info,
            ),
            self.cancel_booking: gapic_v1.method.wrap_method(
                self.cancel_booking,
                default_timeout=None,
                client_info=client_info,
            ),
            self.preview_cancellation: gapic_v1.method.wrap_method(
                self.preview_cancellation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.reschedule_booking: gapic_v1.method.wrap_method(
