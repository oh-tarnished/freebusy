...
from .transports.grpc import OrganisationServiceGrpcTransport
from .transports.grpc_asyncio import OrganisationServiceGrpcAsyncIOTransport


class OrganisationServiceClientMeta(type):
    """Metaclass for the OrganisationService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[OrganisationServiceTransport]]
    _transport_registry["grpc"] = OrganisationServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = OrganisationServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[OrganisationServiceTransport]:
...
class OrganisationServiceClient(metaclass=OrganisationServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            OrganisationServiceClient: The constructed client.
        """
    ...
    def transport(self) -> OrganisationServiceTransport:
        ...
        Returns:
            OrganisationServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def member_path(organisation: str,member: str,) -> str:
        """Returns a fully-qualified member string."""
        return "organisations/{organisation}/members/{member}".format(organisation=organisation, member=member, )

    @staticmethod
    def parse_member_path(path: str) -> Dict[str,str]:
        """Parses a member path into its component segments."""
        m = re.match(r"^organisations/(?P<organisation>.+?)/members/(?P<member>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def organisation_path(organisation: str,) -> str:
        """Returns a fully-qualified organisation string."""
        return "organisations/{organisation}".format(organisation=organisation, )

    @staticmethod
    def parse_organisation_path(path: str) -> Dict[str,str]:
        """Parses a organisation path into its component segments."""
        m = re.match(r"^organisations/(?P<organisation>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = OrganisationServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint) -> str:
        ...
        if api_override is not None:
            ...
            api_endpoint = OrganisationServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = OrganisationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = OrganisationServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, OrganisationServiceTransport, Callable[..., OrganisationServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the organisation service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = OrganisationServiceClient._read_environment_variables()
        self._client_cert_source = OrganisationServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = OrganisationServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, OrganisationServiceTransport)
        if transport_provided:
            # transport is a OrganisationServiceTransport instance.
            ...
            self._transport = cast(OrganisationServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (self._api_endpoint or
            OrganisationServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[OrganisationServiceTransport], Callable[..., OrganisationServiceTransport]] = (
                OrganisationServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., OrganisationServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `freebusy.organisation_v1.OrganisationServiceClient`.",
                    extra = {
    ...
    def list_organisations(self,
        ...
        Args:
            request (Union[freebusy.organisation_v1.types.ListOrganisationsRequest, dict]):
        ...
        Returns:
            freebusy.organisation_v1.services.organisation_service.pagers.ListOrganisationsPager:
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_organisations]
        ...
        response = pagers.ListOrganisationsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_organisation(self,
        ...
        .. code-block:: python
            ...
            def sample_get_organisation():
                ...
                # Make the request
                response = client.get_organisation(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.organisation_v1.types.GetOrganisationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_organisation]
    ...
    def create_organisation(self,
        ...
        .. code-block:: python
            ...
            def sample_create_organisation():
                # Create a client
                client = organisation_v1.OrganisationServiceClient()
                ...
                # Make the request
                response = client.create_organisation(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.organisation_v1.types.CreateOrganisationRequest, dict]):
                The request object. Request message for
                CreateOrganisation.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_organisation]
    ...
    def update_organisation(self,
        ...
        .. code-block:: python
            ...
            def sample_update_organisation():
                # Create a client
                client = organisation_v1.OrganisationServiceClient()
                ...
                # Make the request
                response = client.update_organisation(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.organisation_v1.types.UpdateOrganisationRequest, dict]):
                The request object. Request message for
                UpdateOrganisation.
            organisation (freebusy.organisation_v1.types.Organisation):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_organisation]
    ...
    def delete_organisation(self,
        ...
        .. code-block:: python
            ...
            def sample_delete_organisation():
                # Create a client
                client = organisation_v1.OrganisationServiceClient()
        ...
        Args:
            request (Union[freebusy.organisation_v1.types.DeleteOrganisationRequest, dict]):
                The request object. Request message for
                DeleteOrganisation.
            name (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_organisation]
    ...
    def invite_member(self,
        ...
        .. code-block:: python
            ...
            def sample_invite_member():
                ...
                # Make the request
                response = client.invite_member(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[freebusy.organisation_v1.types.InviteMemberRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.invite_member]
    ...
    def list_members(self,
        ...
        Args:
            request (Union[freebusy.organisation_v1.types.ListMembersRequest, dict]):
        ...
        Returns:
            freebusy.organisation_v1.services.organisation_service.pagers.ListMembersPager:
    ...
    def get_member(self,
        ...
        Args:
            request (Union[freebusy.organisation_v1.types.GetMemberRequest, dict]):
    ...
    def update_member(self,
        ...
        Args:
            request (Union[freebusy.organisation_v1.types.UpdateMemberRequest, dict]):
    ...
    def delete_member(self,
        ...
        Args:
            request (Union[freebusy.organisation_v1.types.DeleteMemberRequest, dict]):
    ...
    def __enter__(self) -> "OrganisationServiceClient":
        return self
