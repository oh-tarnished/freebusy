...
-- CreateIndex
CREATE INDEX "applicable_resources_promo_code_id_idx" ON "promocode"."applicable_resources"("promo_code_id");
...
-- CreateIndex
CREATE INDEX "applicable_offerings_promo_code_id_idx" ON "promocode"."applicable_offerings"("promo_code_id");
...
-- CreateIndex
CREATE INDEX "offerings_link_resource_id_idx" ON "resource"."offerings_link"("resource_id");
...
-- CreateIndex
CREATE INDEX "exceptions_schedule_id_idx" ON "schedule"."exceptions"("schedule_id");
