...
-- CreateTable
CREATE TABLE "promocode"."scope_applicable_resources" (
    "id" TEXT NOT NULL,
    "scope_id" TEXT NOT NULL,
    "resource_id" TEXT NOT NULL,

    CONSTRAINT "scope_applicable_resources_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "promocode"."scope_applicable_offerings" (
    "id" TEXT NOT NULL,
    "scope_id" TEXT NOT NULL,
    "offering_id" TEXT NOT NULL,
    "offering_name" TEXT NOT NULL,

    CONSTRAINT "scope_applicable_offerings_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "scope_applicable_resources_resource_id_idx" ON "promocode"."scope_applicable_resources"("resource_id");

-- CreateIndex
CREATE UNIQUE INDEX "scope_applicable_resources_scope_id_resource_id_key" ON "promocode"."scope_applicable_resources"("scope_id", "resource_id");

-- CreateIndex
CREATE INDEX "scope_applicable_offerings_offering_id_idx" ON "promocode"."scope_applicable_offerings"("offering_id");

-- CreateIndex
CREATE UNIQUE INDEX "scope_applicable_offerings_scope_id_offering_id_key" ON "promocode"."scope_applicable_offerings"("scope_id", "offering_id");
...
-- AddForeignKey
ALTER TABLE "promocode"."scope_applicable_resources" ADD CONSTRAINT "scope_applicable_resources_scope_id_fkey" FOREIGN KEY ("scope_id") REFERENCES "promocode"."scopes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "promocode"."scope_applicable_resources" ADD CONSTRAINT "scope_applicable_resources_resource_id_fkey" FOREIGN KEY ("resource_id") REFERENCES "resource"."entity"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "promocode"."scope_applicable_offerings" ADD CONSTRAINT "scope_applicable_offerings_scope_id_fkey" FOREIGN KEY ("scope_id") REFERENCES "promocode"."scopes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "promocode"."scope_applicable_offerings" ADD CONSTRAINT "scope_applicable_offerings_offering_id_fkey" FOREIGN KEY ("offering_id") REFERENCES "resource"."offerings"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "resource"."offerings" ADD CONSTRAINT "offerings_price_id_fkey" FOREIGN KEY ("price_id") REFERENCES "common"."moneys"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "resource"."rate_overrides" ADD CONSTRAINT "rate_overrides_date_range_id_fkey" FOREIGN KEY ("date_range_id") REFERENCES "shared"."date_ranges"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "resource"."rate_overrides" ADD CONSTRAINT "rate_overrides_price_id_fkey" FOREIGN KEY ("price_id") REFERENCES "common"."moneys"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "resource"."los_discounts" ADD CONSTRAINT "los_discounts_amount_off_id_fkey" FOREIGN KEY ("amount_off_id") REFERENCES "common"."moneys"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "resource"."fees" ADD CONSTRAINT "fees_amount_id_fkey" FOREIGN KEY ("amount_id") REFERENCES "common"."moneys"("id") ON DELETE SET NULL ON UPDATE CASCADE;
