...
type AvailabilityException struct {
	...
	// Back-relation: Schedule records that reference this via exceptions.
	Schedules []Schedule `gorm:"foreignKey:Exceptions" json:"schedules,omitempty"`
}
...
type Schedule struct {
	...
	Exceptions2 *AvailabilityException `gorm:"foreignKey:Exceptions" json:"exceptions2,omitempty"`
...
func (*BufferSettings) TableName() string { return "schedule.buffer_settingss" }
...
func (*StayConstraints) TableName() string { return "schedule.stay_constraintss" }
...
func (*CancellationPolicy) TableName() string { return "schedule.cancellation_policys" }
