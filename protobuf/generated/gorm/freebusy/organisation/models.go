...
type Organisation struct {
	...
	MembershipSummarys []MembershipSummary `gorm:"foreignKey:Organisation" json:"membershipsummarys,omitempty"`
...
type Member struct {
	...
	User2 *User   `gorm:"foreignKey:User" json:"user2,omitempty"`
	...
	Inviter2 *User   `gorm:"foreignKey:Inviter" json:"inviter2,omitempty"`
