...
type Offering struct {
	...
	Price   *booking.Money `gorm:"foreignKey:PriceID;constraint:OnDelete:SET NULL" json:"price,omitempty"`
...
type RateOverride struct {
	...
	DateRange   *schedule.DateRange `gorm:"foreignKey:DateRangeID;constraint:OnDelete:SET NULL" json:"daterange,omitempty"`
	// Foreign key to Money.
	PriceID string         `gorm:"column:price_id;not null;index:idx_rate_overrides_price_id" json:"price_id" validate:"required"`
	Price   *booking.Money `gorm:"foreignKey:PriceID;constraint:OnDelete:CASCADE" json:"price,omitempty"`
}
...
type Fee struct {
	...
	Amount   *booking.Money `gorm:"foreignKey:AmountID;constraint:OnDelete:SET NULL" json:"amount,omitempty"`
}
