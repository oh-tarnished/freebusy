...
type Resource struct {
	...
	Offerings2 *Offering `gorm:"foreignKey:Offerings" json:"offerings2,omitempty"`
	// Lifecycle state.
	...
	// Back-relation: PromoCode records that reference this via applicable_resources.
	PromoCodes []PromoCode `gorm:"foreignKey:ApplicableResources" json:"promocodes,omitempty"`
	// Back-relation: Offering records that reference this via resource_id.
	Offerings3 []Offering `gorm:"foreignKey:ResourceID" json:"offerings3,omitempty"`
...
type Offering struct {
	...
	// Back-relation: PromoCode records that reference this via applicable_offerings.
	PromoCodes []PromoCode `gorm:"foreignKey:ApplicableOfferings" json:"promocodes,omitempty"`
	// Back-relation: Resource records that reference this via offerings.
	Resources []Resource `gorm:"foreignKey:Offerings" json:"resources,omitempty"`
	...
	Taxs []Tax `gorm:"foreignKey:OfferingID" json:"taxs,omitempty"`
}
...
func (*Tax) TableName() string { return "resource.taxs" }
