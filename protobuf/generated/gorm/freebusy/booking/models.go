...
type Booking struct {
	...
	Resource2 *Resource `gorm:"foreignKey:Resource" json:"resource2,omitempty"`
	...
	Offering2 *Offering `gorm:"foreignKey:Offering" json:"offering2,omitempty"`
	// The user the booking is for. Format: users/{user}
	Customer  *string `gorm:"column:customer" json:"customer,omitempty"`
	Customer2 *User   `gorm:"foreignKey:Customer" json:"customer2,omitempty"`
	...
	PromoCode2 *PromoCode `gorm:"foreignKey:PromoCode" json:"promocode2,omitempty"`
