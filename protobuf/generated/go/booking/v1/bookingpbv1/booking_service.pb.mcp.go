...
var BookingService_ConfirmBookingSchemaJSON = `{"description":"Confirm a held booking (PENDING_HOLD -\u003e CONFIRMED), optionally recording a payment reference.","properties":{"name":{"type":"string"},"payment_ref":{"type":"string"}},"required":["name"],"type":"object"}`
var BookingService_CreateBookingSchemaJSON = `{"description":"Create a booking and place a hold on a resource for a span. Requires an idempotency key; optionally apply a promo code.","properties":{"booking":{"properties":{"assigned_unit":{"type":"string"},"attributes":{"additionalProperties":true,"type":"object"},"cancel_reason":{"enum":["CANCEL_REASON_UNSPECIFIED","CANCEL_REASON_REQUESTED_BY_CUSTOMER","CANCEL_REASON_REQUESTED_BY_OPERATOR","CANCEL_REASON_PAYMENT_FAILED","CANCEL_REASON_NO_SHOW","CANCEL_REASON_OTHER"],"type":"string"},"cancel_time":{"format":"date-time","type":["string","null"]},"confirm_time":{"format":"date-time","type":["string","null"]},"create_time":{"format":"date-time","type":["string","null"]},"customer":{"type":"string"},"discount":{"properties":{"currency_code":{"type":"string"},"decimal_places":{"type":"integer"},"units":{"type":"string"}},"required":["currency_code"],"type":"object"},"hold_expire_time":{"format":"date-time","type":["string","null"]},"hold_ttl":{"pattern":"^-?[0-9]+(\\.[0-9]+)?s$","type":["string","null"]},"name":{"type":"string"},"notes":{"type":"string"},"offering":{"type":"string"},"price":{"properties":{"currency_code":{"type":"string"},"decimal_places":{"type":"integer"},"units":{"type":"string"}},"required":["currency_code"],"type":"object"},"promo_code":{"type":"string"},"resource":{"type":"string"},"state":{"enum":["STATE_UNSPECIFIED","STATE_PENDING_HOLD","STATE_CONFIRMED","STATE_CANCELLED","STATE_EXPIRED","STATE_COMPLETED","STATE_NO_SHOW"],"type":"string"},"total":{"properties":{"currency_code":{"type":"string"},"decimal_places":{"type":"integer"},"units":{"type":"string"}},"required":["currency_code"],"type":"object"},"units":{"type":"integer"},"update_time":{"format":"date-time","type":["string","null"]},"uuid":{"type":"string"},"window":{"properties":{"end_time":{"format":"date-time","type":["string","null"]},"start_time":{"format":"date-time","type":["string","null"]}},"required":["start_time","end_time"],"type":"object"}},"required":["resource","window"],"type":"object"},"booking_id":{"type":"string"},"request_id":{"type":"string"}},"required":["booking"],"type":"object"}`
