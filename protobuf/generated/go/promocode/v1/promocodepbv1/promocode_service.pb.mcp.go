...
var PromoCodeService_ValidatePromoCodeSchemaJSON = `{"description":"Check whether a code applies to a booking (property/unit/subtotal/customer) and compute the discount and final total.","properties":{"code":{"type":"string"},"customer":{"type":"string"},"property":{"type":"string"},"subtotal":{"properties":{"currency_code":{"type":"string"},"nanos":{"type":"integer"},"units":{"type":"string"}},"required":[],"type":"object"},"unit":{"type":"string"}},"required":["code","subtotal"],"type":"object"}`
