...
var ResourceService_UpdateOfferingSchemaJSON = `{"description":"Update an offering's name, duration, price, or status.","properties":{"offering":{"properties":{"create_time":{"format":"date-time","type":["string","null"]},"description":{"type":"string"},"display_name":{"type":"string"},"duration":{"pattern":"^-?[0-9]+(\\.[0-9]+)?s$","type":["string","null"]},"etag":{"type":"string"},"name":{"type":"string"},"price":{"properties":{"currency_code":{"type":"string"},"nanos":{"type":"integer"},"units":{"type":"string"}},"required":[],"type":"object"},"pricing_unit":{"enum":["PRICING_UNIT_UNSPECIFIED","PRICING_UNIT_PER_BOOKING","PRICING_UNIT_PER_NIGHT","PRICING_UNIT_PER_PERSON"],"type":"string"},"state":{"enum":["STATE_UNSPECIFIED","STATE_ACTIVE","STATE_INACTIVE"],"type":"string"},"update_time":{"format":"date-time","type":["string","null"]}},"required":["display_name"],"type":"object"},"update_mask":{"type":"string"}},"required":["offering"],"type":"object"}`
