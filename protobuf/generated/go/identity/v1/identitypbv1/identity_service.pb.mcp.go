...
var IdentityService_UpdateUserSchemaJSON = `{"description":"Update the signed-in user's profile: display name, avatar, locale, or time zone.","properties":{"update_mask":{"type":"string"},"user":{"properties":{"avatar_url":{"type":"string"},"create_time":{"format":"date-time","type":["string","null"]},"display_name":{"type":"string"},"email":{"type":"string"},"etag":{"type":"string"},"locale":{"type":"string"},"memberships":{"items":{"properties":{"org_display_name":{"type":"string"},"organisation":{"type":"string"},"role":{"type":"string"}},"required":[],"type":"object"},"type":"array"},"name":{"type":"string"},"time_zone":{"type":"string"},"update_time":{"format":"date-time","type":["string","null"]}},"required":[],"type":"object"}},"required":["user"],"type":"object"}`
