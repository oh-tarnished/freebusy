...
merged = {
    ...
    "info": {
        ...
        "description": (
            "FreeBusy is a scheduling platform that exposes resources, schedules, "
        ...
        "version": "1.0.0",
        "termsOfService": "https://freebusy.oh-tarnished.dev/terms",
        "contact": {
            "name": "FreeBusy API Support",
            "url": "https://freebusy.oh-tarnished.dev/support",
    ...
    "externalDocs": {
        "description": "FreeBusy API documentation",
        "url": "https://freebusy.oh-tarnished.dev/docs",
    },
    "servers": [
        {"url": "https://freebusy.oh-tarnished.dev", "description": "Production"},
        {"url": "https://staging.freebusy.oh-tarnished.dev", "description": "Staging"},
