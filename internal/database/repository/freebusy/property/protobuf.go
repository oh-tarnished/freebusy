...
func sharedAttachmentFromRow(row *sharedschemaql.SharedAttachments) *sharedpbv1.Attachment {
	if row == nil {
		return nil
	}
...
func commonPostalAddressFromRow(row *commonschemaql.CommonPostalAddress) *postaladdress.PostalAddress {
	if row == nil {
		return nil
	}
...
func propertyPolicyFromRow(row *schemaql.PropertyPolicies) *propertypbv1.Policy {
	if row == nil {
		return nil
	}
