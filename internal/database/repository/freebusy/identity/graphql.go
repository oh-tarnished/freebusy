...
func (r *GraphQLUserRepository) toProto(ctx context.Context, row *schemaql.IdentityUsers) (*identitypbv1.User, error) {
	out := userFromRow(row)
...
func (r *GraphQLUserRepository) list(ctx context.Context, in repox.ListInput, scope ...graphql.Predicate) ([]*identitypbv1.User, string, error) {
	...
	eng := filterx.Hasura[schemaql.IdentityUsers](identity.UserFilterSpec, r.Svc.Query.Identity.Users).Scope(scope...)
