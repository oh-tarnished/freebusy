...
func sharedContactFromRow(row *sharedschemaql.SharedContacts) *sharedpbv1.Contact {
	if row == nil {
		return nil
	}
...
func bookingOccupancyFromRow(row *schemaql.BookingOccupancies) *bookingpbv1.Occupancy {
	if row == nil {
		return nil
	}
