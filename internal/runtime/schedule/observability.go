...
type rpcMetrics struct {
	Requests int64 `pulse:"metric:counter:schedule.rpc.requests"`
	Errors   int64 `pulse:"metric:counter:schedule.rpc.errors"`
}

// traced runs fn inside a pulse span named "ScheduleService/<method>", records
...
func traced(ctx context.Context, method string, fn func(context.Context) error) error {
	return shared.Pulse.Tracing.Trace(ctx, "ScheduleService/"+method, nil, func(ctx context.Context, _ *pulse.Span) error {
		err := fn(ctx)
